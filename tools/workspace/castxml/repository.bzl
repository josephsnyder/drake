...
def _impl(repo_ctx):
    ...
    if os_result.is_macos:
        ...
        url = "https://data.kitware.com/api/v1/file/5f87645250a41e3d19eb4d4b/download"  # noqa
        ...
        # Nightly: https://data.kitware.com/#collection/57b5c9e58d777f126827f5a1/folder/5f873c1350a41e3d19eae63e # noqa
        url = "https://data.kitware.com/api/v1/file/5f87643050a41e3d19eb4d3c/download"  # noqa
        sha256 = "3c9cae4157d807e9f7106a88473abe92b3ecaa0b16645202b5df1bb8769c6dba"  # noqa
        repo_ctx.download_and_extract(
            url = url,
            sha256 = sha256,
            type = "tar.gz",
