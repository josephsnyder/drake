 ...
 */)""");
  ...
  Monomial.def(py::init<::drake::symbolic::Monomial const &>(),py::arg("arg0"))
    ...
    .def(py::init<::drake::symbolic::Variable const &,int>(),py::arg("var"),py::arg("exponent"))
    .def_static("DRAKE_COPYABLE_DEMAND_COPY_CAN_COMPILE", static_cast<void (*)(  )>(&::drake::symbolic::Monomial::DRAKE_COPYABLE_DEMAND_COPY_CAN_COMPILE))
    .def("Evaluate", static_cast<double ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Environment const & )const>(&::drake::symbolic::Monomial::Evaluate), py::arg("env"), 
 ...
 */)""")
    .def("EvaluatePartial", static_cast<::std::pair<double, drake::symbolic::Monomial> ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Environment const & )const>(&::drake::symbolic::Monomial::EvaluatePartial), py::arg("env"), 
 ...
 *   = (2³ = 8, y²). 
 */)""")
    .def("GetVariables", static_cast<::drake::symbolic::Variables ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::GetVariables), 
R"""(/** Returns the set of variables in this monomial. */)""")
    .def("ToExpression", static_cast<::drake::symbolic::Expression ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::ToExpression), 
R"""(/** Returns a symbolic expression representing this monomial. */)""")
    .def("degree", static_cast<int ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Variable const & )const>(&::drake::symbolic::Monomial::degree), py::arg("v"), 
R"""(/** Returns the degree of this Monomial in a variable @p v. */)""")
    .def("get_powers", static_cast<::std::map<drake::symbolic::Variable, int, std::less<drake::symbolic::Variable>, std::allocator<std::pair<const drake::symbolic::Variable, int>>> const & ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::get_powers), 
R"""(/** Returns the internal representation of Monomial, the map from a base 
 * (Variable) to its exponent (int).*/)""")
    .def("pow_in_place", static_cast<::drake::symbolic::Monomial & ( ::drake::symbolic::Monomial::* )( int )>(&::drake::symbolic::Monomial::pow_in_place), py::arg("p"), 
R"""(/** Returns this monomial raised to @p p. 
 * @throws std::runtime_error if @p p is negative. 
 */)""")
    .def("total_degree", static_cast<int ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::total_degree), 
R"""(/** Returns the total degree of this Monomial. */)""")
    
    .def("__neq__", static_cast<bool ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Monomial const & )const>(&::drake::symbolic::Monomial::operator!=), py::arg("m"), 
R"""(/** Checks if this monomial and @p m do not represent the same monomial. */)""")
    .def("__imul__", static_cast<::drake::symbolic::Monomial & ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Monomial const & )>(&::drake::symbolic::Monomial::operator*=), py::arg("m"), 
R"""(/** Returns this monomial multiplied by @p m. */)""")
    .def("__str__", +[](::drake::symbolic::Monomial const & m) {
        ...
        return s;})        .def("__eq__", static_cast<bool ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Monomial const & )const>(&::drake::symbolic::Monomial::operator==), py::arg("m"), 
