 ...
 */");
  ...
  Monomial.def(py::init<::drake::symbolic::Monomial const &>(),py::arg("arg0"))
    ...
    .def("degree", static_cast<int ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Variable const & )const>(&::drake::symbolic::Monomial::degree), py::arg("v"), "/** Returns the degree of this Monomial in a variable @p v. */")
    .def("total_degree", static_cast<int ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::total_degree), "/** Returns the total degree of this Monomial. */")
    .def("GetVariables", static_cast<::drake::symbolic::Variables ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::GetVariables), "/** Returns the set of variables in this monomial. */")
    .def("get_powers", static_cast<::std::map<drake::symbolic::Variable, int, std::less<drake::symbolic::Variable>, std::allocator<std::pair<const drake::symbolic::Variable, int>>> const & ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::get_powers), "/** Returns the internal representation of Monomial, the map from a base \
 * (Variable) to its exponent (int).*/")
    .def("Evaluate", static_cast<double ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Environment const & )const>(&::drake::symbolic::Monomial::Evaluate), py::arg("env"), "/** Evaluates under a given environment @p env. \
 * \
 * @throws std::out_of_range exception if there is a variable in this monomial \
 * whose assignment is not provided by @p env. \
 */")
    .def("EvaluatePartial", static_cast<::std::pair<double, drake::symbolic::Monomial> ( ::drake::symbolic::Monomial::* )( ::drake::symbolic::Environment const & )const>(&::drake::symbolic::Monomial::EvaluatePartial), py::arg("env"), "/** Partially evaluates using a given environment @p env. The evaluation \
 ...
 *   = (2³ = 8, y²). \
 */")
    .def("ToExpression", static_cast<::drake::symbolic::Expression ( ::drake::symbolic::Monomial::* )(  )const>(&::drake::symbolic::Monomial::ToExpression), "/** Returns a symbolic expression representing this monomial. */")
    .def("pow_in_place", static_cast<::drake::symbolic::Monomial & ( ::drake::symbolic::Monomial::* )( int )>(&::drake::symbolic::Monomial::pow_in_place), py::arg("p"), "/** Returns this monomial raised to @p p. \
