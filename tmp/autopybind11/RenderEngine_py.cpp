...
void apb11_pydrake_RenderEngine_py_register(py::module &m) {
 ...
 \
   - Label (ImageLabel16I) : the label image has single channel represented \
     ...
     which corresponds to an object class in the scene or an " empty
      " pixel (see \
 ...
 */")
 ...
 RenderLabel.  */")
      .def_static("GetColorIFromLabel",
                  ...
                  py::arg("label"),
                  "/** Transforms `this` render label into a byte-valued RGB "
                  "color.  */")
      .def_static("GetColorDFromLabel",
                  ...
                  py::arg("label"),
                  "/** Transforms `this` render label into a double-valued RGB "
                  "color.  */")
