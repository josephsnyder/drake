...
may invalidate cache entries as a result. */")
  ...
  py::class_<::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>,
  ...
  System_Eigen_AutoDiffScalar_Eigen_VectorXd
      .def("Accept",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::SystemVisitor<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *v) {
      ...
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::AllocateCompositeEventCollection),
          "/** Allocates a CompositeEventCollection for this system. The allocated \
instance is used for populating collections of triggered events; for \
example, Simulator passes this object to System::CalcNextUpdateTime() to \
allow the system to identify and handle upcoming events. */")
      .def("AllocateInputVector",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::InputPort<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &input_port) {
      ...
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::AllocateOutput),
          "/** Returns a container that can hold the values of all of this System's \
output ports. It is sized with the number of output ports and uses each \
output port's allocation method to provide an object of the right type \
for that port. */")
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::AllocateTimeDerivatives),
          "/** Returns a ContinuousState of the same size as the continuous_state \
allocated in CreateDefaultContext. The simulator will provide this state \
as the output argument to EvalTimeDerivatives. */")
      .def(
          ...
          static_cast<::Eigen::Matrix<Eigen::AutoDiffScalar<Eigen::VectorXd>,
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::AllocateImplicitTimeDerivativesResidual),
          "/** Returns an Eigen VectorX suitable for use as the output argument to \
the CalcImplicitTimeDerivativesResidual() method. The returned VectorX \
will have size implicit_time_derivatives_residual_size() with the \
elements uninitialized. This is just a convenience method -- you are free \
      ...
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::AllocateDiscreteVariables),
          "/** Returns a DiscreteValues of the same dimensions as the discrete_state \
allocated in CreateDefaultContext. The simulator will provide this state \
as the output argument to Update. */")
      .def(
          ...
          static_cast<
              ::std::unique_ptr<drake::systems::Context<::drake::AutoDiffXd>,
                  ...
                  ::drake::systems::System<
                      Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::CreateDefaultContext),
          "/** This convenience method allocates a context using AllocateContext() and \
sets its default values using SetDefaultContext(). */")
      .def("SetDefaultState",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context,
              ::drake::systems::State<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  *state) { return self.SetDefaultState(context, state); })
      .def("SetDefaultParameters",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Context<
              ...
              ::drake::systems::Parameters<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *parameters) {
             return self.SetDefaultParameters(context, parameters);
           })
      .def("SetDefaultContext",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Context<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  *context) { return self.SetDefaultContext(context); })
      .def("SetRandomState",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Context<
      ...
      .def("AllocateFixedInputs",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Context<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  *context) { return self.AllocateFixedInputs(context); })
      .def(
          "HasAnyDirectFeedthrough",
          static_cast<bool (::drake::systems::System<Eigen::AutoDiffScalar<
                                Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::HasAnyDirectFeedthrough),
          "/** Returns `true` if any of the inputs to the system might be directly \
fed through to any of its outputs and `false` otherwise. */")
      .def(
          "HasDirectFeedthrough",
          static_cast<bool (::drake::systems::System<Eigen::AutoDiffScalar<
              ...
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::HasDirectFeedthrough),
          py::arg("output_port"),
          "/** Returns true if there might be direct-feedthrough from any input port to \
the given @p output_port, and false otherwise. */")
      .def(
      ...
      .def(
          ...
          static_cast<::drake::systems::CacheEntry const &(
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::get_time_derivatives_cache_entry),
          "/** (Advanced) Returns the CacheEntry used to cache time derivatives for \
EvalTimeDerivatives(). */")
      .def(
          "EvalPotentialEnergy",
      ...
      .def(
          ...
          static_cast<::drake::systems::SystemConstraintIndex (
              ::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>::
                  *)(::drake::systems::ExternalSystemConstraint)>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::AddExternalConstraint),
          py::arg("constraint"),
          "/** Adds an " external " constraint to this System. \
 \
This method is intended for use by applications that are examining this \
...
conversion. */")
      .def("CalcTimeDerivatives",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::ContinuousState<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *derivatives) {
      ...
      .def("CalcImplicitTimeDerivativesResidual",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context,
              ::drake::systems::ContinuousState<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>> const &proposed_derivatives,
              Eigen::Ref<
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>> &
             ...
             ::drake::systems::DiscreteValues<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> *discrete_state) {
      ...
      .def("CalcNextUpdateTime",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context,
              ::drake::systems::CompositeEventCollection<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *events) {
      ...
      .def(
          ...
          static_cast<::std::optional<drake::systems::PeriodicEventData> (
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::GetUniquePeriodicDiscreteUpdateAttribute),
          "/** Gets whether there exists a unique periodic attribute that triggers \
one or more discrete update events (and, if so, returns that unique \
periodic attribute). Thus, this method can be used (1) as a test to \
determine whether a system's dynamics are at least partially governed by \
...
attributes if the unique periodic attribute exists, otherwise `nullopt`. */")
      .def(
          ...
          static_cast<bool (::drake::systems::System<Eigen::AutoDiffScalar<
              ...
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::IsDifferenceEquationSystem),
          py::arg("time_period") = (double *)nullptr,
          "/** Returns true iff the state dynamics of this system are governed \
exclusively by a difference equation on a single discrete state group \
and with a unique periodic update (having zero offset).  E.g., it is \
...
that are to be triggered at the proper times. */")
      .def("CalcOutput",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::SystemOutput<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *outputs) {
      ...
      .def("MapVelocityToQDot",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context,
              ::drake::systems::VectorBase<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>> const &generalized_velocity,
              ::drake::systems::VectorBase<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *qdot) {
             return self.MapVelocityToQDot(context, generalized_velocity, qdot);
           })
      .def("MapVelocityToQDot",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
      ...
      .def("MapQDotToVelocity",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context,
              ::drake::systems::VectorBase<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &qdot,
              ::drake::systems::VectorBase<Eigen::AutoDiffScalar<
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                 &self,
             ::drake::systems::System<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &subsystem,
             ::drake::systems::Context<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &context) {
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                 &self,
             ::drake::systems::Context<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &root_context) {
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                 &self,
             ::drake::systems::System<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &target_system,
             ::drake::systems::Context<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const *context) {
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
             ...
             ::drake::systems::System<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &target_system,
             ::drake::systems::State<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const *state) {
      ...
      .def(
          ...
          [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
             ...
             ::drake::systems::System<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const &target_system,
             ::drake::systems::ContinuousState<
                 Eigen::AutoDiffScalar<Eigen::VectorXd>> const *xc) {
      ...
      .def("AllocateForcedPublishEventCollection",
           static_cast<::std::unique_ptr<
               ...
               ::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
               &::drake::systems::System<Eigen::AutoDiffScalar<
                   Eigen::VectorXd>>::AllocateForcedPublishEventCollection),
           "")
      .def("AllocateForcedDiscreteUpdateEventCollection",
           static_cast<::std::unique_ptr<
               drake::systems::EventCollection<
...
because the address can vary from run to run. */")
      .def("get_input_port",
           static_cast<::drake::systems::InputPort<
               Eigen::AutoDiffScalar<Eigen::VectorXd>> const
                           &(::drake::systems::System<Eigen::AutoDiffScalar<
                                 Eigen::VectorXd>>::*)(int)const>(
               &::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::get_input_port),
           py::arg("port_index"),
           "/** Returns the typed input port at index @p port_index. */",
           py::return_value_policy::reference_internal)
      .def("get_input_port",
              ...
              ::drake::systems::InputPort<
                  ...
                  *(::drake::systems::System<
                      Eigen::AutoDiffScalar<Eigen::VectorXd>>::
                        *)(::std::variant<
                           drake::systems::InputPortSelection,
                           drake::TypeSafeIndex<drake::systems::InputPortTag>>)
                      const>(&::drake::systems::System<Eigen::AutoDiffScalar<
                                 Eigen::VectorXd>>::get_input_port_selection),
          py::arg("port_index"),
          "/** Returns the typed input port specified by the InputPortSelection or by \
the InputPortIndex.  Returns nullptr if no port is selected.  This is \
provided as a convenience method since many algorithms provide the same \
common default or optional port semantics. */",
      ...
      .def(
          ...
          static_cast<::drake::systems::InputPort<
              Eigen::AutoDiffScalar<Eigen::VectorXd>> const
                          &(::drake::systems::System<Eigen::AutoDiffScalar<
                                Eigen::VectorXd>>::*)(::std::string const &)
                              const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::GetInputPort),
          py::arg("port_name"),
          "/** Returns the typed input port with the unique name @p port_name. \
The current implementation performs a linear search over strings; prefer \
get_input_port() when performance is a concern. \
@throws std::logic_error if port_name is not found. */",
          py::return_value_policy::reference_internal)
      .def("HasInputPort",
           static_cast<bool (::drake::systems::System<
                             Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)(
               ::std::string const &) const>(
               &::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::HasInputPort),
           py::arg("port_name"),
           "/** Returns true iff the system has an InputPort of the given @p \
 port_name. */")
      .def("get_output_port",
           static_cast<::drake::systems::OutputPort<
               Eigen::AutoDiffScalar<Eigen::VectorXd>> const
                           &(::drake::systems::System<Eigen::AutoDiffScalar<
                                 Eigen::VectorXd>>::*)(int)const>(
               &::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::get_output_port),
           py::arg("port_index"),
           "/** Returns the typed output port at index @p port_index. */",
           py::return_value_policy::reference_internal)
      .def("get_output_port",
                  ...
                  *(::drake::systems::System<
                      Eigen::AutoDiffScalar<Eigen::VectorXd>>::
                        *)(::std::variant<
                           ...
                           drake::TypeSafeIndex<drake::systems::OutputPortTag>>)
                      const>(&::drake::systems::System<Eigen::AutoDiffScalar<
                                 Eigen::VectorXd>>::get_output_port_selection),
          py::arg("port_index"),
          "/** Returns the typed output port specified by the OutputPortSelection or by \
the OutputPortIndex.  Returns nullptr if no port is selected. This is \
provided as a convenience method since many algorithms provide the same \
          ...
          static_cast<::drake::systems::OutputPort<
              Eigen::AutoDiffScalar<Eigen::VectorXd>> const
                          &(::drake::systems::System<Eigen::AutoDiffScalar<
                              ...
                              const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::GetOutputPort),
          py::arg("port_name"),
          "/** Returns the typed output port with the unique name @p port_name. \
The current implementation performs a linear search over strings; prefer \
get_output_port() when performance is a concern. \
@throws std::logic_error if port_name is not found. */",
      ...
      .def("HasOutputPort",
           static_cast<bool (::drake::systems::System<
               ...
               ::std::string const &) const>(
               &::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::HasOutputPort),
           py::arg("port_name"),
           "/** Returns true iff the system has an OutputPort of the given @p \
 port_name. */")
      .def(
          "num_constraints",
          static_cast<int (::drake::systems::System<
                           Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::num_constraints),
          "/** Returns the number of constraints specified for the system. */")
      .def("get_constraint",
           static_cast<::drake::systems::SystemConstraint<
               Eigen::AutoDiffScalar<Eigen::VectorXd>> const
                           &(::drake::systems::System<
                               Eigen::AutoDiffScalar<Eigen::VectorXd>>::
                                 *)(::drake::systems::SystemConstraintIndex)
                               const>(
               &::drake::systems::System<
                   Eigen::AutoDiffScalar<Eigen::VectorXd>>::get_constraint),
           py::arg("constraint_index"),
           "/** Returns the constraint at index @p constraint_index. \
@throws std::out_of_range for an invalid constraint_index. */",
           py::return_value_policy::reference_internal)
      ...
      .def("CheckValidOutput",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::SystemOutput<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const *output) {
      ...
      .def(
          ...
          static_cast<::std::string (
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)(int) const>(
              &::drake::systems::System<
...
*/")
      .def(
          "GetGraphvizFragment",
          static_cast<void (::drake::systems::System<
                            Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)(
              int, ::std::stringstream *) const>(
              &::drake::systems::System<
...
visualize.  Set to zero to render a diagram as a single system block. */")
      .def("GetGraphvizInputPortToken",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::InputPort<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &port,
      ...
      .def(
          "GetGraphvizId",
          static_cast<::int64_t (::drake::systems::System<Eigen::AutoDiffScalar<
                                     Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::GetGraphvizId),
          "/** Returns an opaque integer that uniquely identifies this system in the \
Graphviz output. */")
      .def(
          "ToAutoDiffXd",
          static_cast<
              ::std::unique_ptr<drake::systems::System<::drake::AutoDiffXd>,
                  ...
                  ::drake::systems::System<
                      Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::ToAutoDiffXd),
          "/** Creates a deep copy of this System, transmogrified to use the autodiff \
scalar type, with a dynamic-sized vector of partial derivatives.  The \
result is never nullptr. \
@throws std::exception if this System does not support autodiff \
      ...
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::ToSymbolic),
          "/** Creates a deep copy of this System, transmogrified to use the symbolic \
scalar type. The result is never nullptr. \
@throws std::exception if this System does not support symbolic \
 \
      ...
      .def(
          ...
          static_cast<::std::unique_ptr<
              ...
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::ToSymbolicMaybe),
          "/** Creates a deep copy of this system exactly like ToSymbolic(), but returns \
nullptr if this System does not support symbolic, instead of throwing an \
exception. */")
      ...
      .def(
          ...
          static_cast<::drake::systems::SystemScalarConverter const &(
              ::drake::systems::System<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>>::*)() const>(
              &::drake::systems::System<Eigen::AutoDiffScalar<
                  Eigen::VectorXd>>::get_system_scalar_converter),
          "/** (Advanced) Returns the SystemScalarConverter for this object.  This is an \
expert-level API intended for framework authors.  Most users should \
prefer the convenience helpers such as System::ToAutoDiffXd. */")
      .def("GetWitnessFunctions",
      ...
      .def("CalcWitnessValue",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
              ...
              ::drake::systems::WitnessFunction<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &witness_func) {
             return self.CalcWitnessValue(context, witness_func);
           })
      .def("AddTriggeredWitnessFunctionToCompositeEventCollection",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Event<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  *event,
              ::drake::systems::CompositeEventCollection<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *events) {
      ...
      .def("DoGetWitnessFunctions",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::Context<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> const &arg0,
              ::std::vector<
                  const drake::systems::WitnessFunction<::drake::AutoDiffXd> *,
                  std::allocator<const drake::systems::WitnessFunction<
...
@note The default implementation returns an empty map. */")
      ...
      .def("GetMutableOutputVector",
           [](::drake::systems::System<Eigen::AutoDiffScalar<Eigen::VectorXd>>
                  &self,
              ::drake::systems::SystemOutput<
                  Eigen::AutoDiffScalar<Eigen::VectorXd>> *output,
              int port_index) {
