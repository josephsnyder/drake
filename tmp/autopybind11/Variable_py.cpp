...
void apb11_pydrake_Variable_py_register(py::module &m) {
  ...
  py::class_<::drake::symbolic::Variable> Variable(
      m, "Variable", "/** Represents a symbolic variable. \
 * \
 ...
 */");
  ...
  py::enum_<::drake::symbolic::Variable::Type>(Variable, "Type",
                                               py::arithmetic(), "")
 ...
 *  the default constructor. */")
      .def("get_id",
           static_cast<::drake::symbolic::Variable::Id (
      ...
      .def("less",
           ...
           py::arg("v"), "/// Compares two variables based on their ID values.")
